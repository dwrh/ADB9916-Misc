...
$REG = 13;
$CTY = 48;
//$tabs = array(“Economy_Asia.php”=>”Page One”, “Economy_AFG.php”=>”Page Two”, “Economy_AZE.php”=>”Page Three”, “page4″=>”Page Four”);
...
$strXML_ch2 .= "<categories>";
		for ($hh=0; $hh <= $REG; $hh++) {
			$strXML_ch2 .= "<category label='" . $dtarr[$hh][1] . "' />"; }
$strXML_ch2 .= "</categories>";
...
$strXML_ch2 .= "<dataset seriesName=''>";
		for ($jjj=0; $jjj < $row; $jjj++) {
			if ($dtarr[$jjj][2] == 'mfg_exp') {
				$strXML_ch2 .= "<set value='" . $dtarr[$jjj][6] . "' />"; }
		}
$strXML_ch2 .= "</dataset>";
$strXML_ch2 .= "<dataset seriesName=''>";
		for ($jjjj=0; $jjjj < $row; $jjjj++) {
			if ($dtarr[$jjjj][2] == 'serv_exp') {
				$strXML_ch2 .= "<set value='" . $dtarr[$jjjj][6] . "' />"; }
		}
$strXML_ch2 .= "</dataset>";
$strXML_ch2 .= "</chart>";
...
$strXML_p1 = "<chart caption='Shares of Asian GDP, 2030' bgColor='#FFFFFFF' showBorder='0' showLabels='1' showPercentValues='0' showValues='0' legendPosition='bottom' palette='3'>";
		for ($k=0; $k < $row; $k++) {
			if ($dtarr[$k][2] == 'gdp') {
				$strXML_p1 .= "<set label='" . $dtarr[$k][1] . "' value='" . $dtarr[$k][6] . "' />"; }
		}
$strXML_p1 .= "</chart>";
...
$strXML_p2 = "<chart palette='3' caption='Shares of Employment Growth, 2010-2030' bgColor='#FFFFFFF' showBorder='0' showPercentValues='0' showValues='0'>";
		for ($k=0; $k < $row; $k++) {
			if ($dtarr[$k][2] == 'emp_gr') {
					if ($dtarr[$k][6] > 0) {
				$strXML_p2 .= "<set label='" . $dtarr[$k][1] . "' value='" . $dtarr[$k][6] . "' />"; }
			}
		}
$strXML_p2 .= "</chart>";
...
<td>
	...
	<td class="figs">
	<?php
	echo renderChart("../FusionMaps_XT_Website/Maps/FCMap_Asia.swf", "", $strXML_m1, "GDPM", 800, 480, false, true);
	?>
	</td>
	</tr>
	<tr>
	...
	<tr valign="top"><td>
	<?php
	echo renderChart("FusionCharts/pie2D.swf", "", $strXML_p1, "RGDPp", 400, 300, false, true);
	?>
	</td></tr>
	<tr><td>
	<?php
	echo renderChart("FusionCharts/pie2D.swf", "", $strXML_p2, "RGDPPPp", 400, 300, false, true);
	?>
	</table>
	</td>
	</tr>
