...
if (isset($_GET['tid'])) {
    ...
    try {
        ...
        $query = $pdo->prepare(" SELECT * FROM `RFIDinfoEPC` WHERE `epc` = :epc ");
        ...
        if ($rows[0] != 0) {
            ...
            if ($differenceInSeconds <= 3600) {
                ...
                $query = $pdo->prepare(" INSERT INTO `AnimalEvent` "
                        ...
                        . "`CurrentManager`, `ManagerMobile`, `EventLat`, `EventLong`, `EPC`, `TID`)"
                        . " VALUES (:aid, :MeansofArrival, :MeansofDeparture, :EventType, UTC_TIMESTAMP(), :CurrentManager,"
                        . " :ManagerMobile, :EventLat, :EventLong, :EPC, :TID);");
