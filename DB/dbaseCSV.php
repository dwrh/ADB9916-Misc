...
<div class="navigation flotlef"><div id="menuwrapper">
	<ul id="primary-nav">
		...
		<li class="menuparent"><a class="menuparent" href="db_register.php">Register</a>
		<li class="menuparent"><a class="menuparent" href="db_event.php">Event</a>
		<li class="menuparent"><a class="menuparent" href="db_scan.php">Scan</a>
